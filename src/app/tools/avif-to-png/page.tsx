...
export default function AvifToPngPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">AVIF to PNG Converter</h1>
        <p className="text-muted-foreground mt-1">
          Convert AVIF images to PNG format with lossless quality. Make your AVIF files universally compatible for editing and sharing.
        </p>
      ...
      <section className="space-y-4 py-8 border-t">
        <Tabs defaultValue="what">
          <TabsList>
            <TabsTrigger value="what">What is AVIF to PNG?</TabsTrigger>
          ...
          <TabsContent value="what" className="mt-4 space-y-3 text-muted-foreground text-sm">
            <h2 className="text-lg font-semibold text-foreground">What is AVIF to PNG Conversion?</h2>
            <p>
              AVIF (AV1 Image File Format) is a next-generation image format based on the AV1 video codec. It offers
              exceptional compression, often outperforming both WebP and JPG. However, AVIF support is still growing,
              and many image editors and older applications cannot open AVIF files.
            </p>
            <h3 className="text-base font-semibold text-foreground">When to Convert AVIF to PNG</h3>
            <p>
              Convert AVIF to PNG when you need to edit images in applications that don&apos;t support AVIF (like older
              versions of Photoshop), share files with universal compatibility, or when you need a lossless format
              that preserves transparency for further editing.
            </p>
          </TabsContent>
          ...
          <TabsContent value="faq" className="mt-4 space-y-4 text-muted-foreground text-sm">
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground">Will the PNG file be larger than the AVIF?</h3>
              <p>Yes, typically much larger. AVIF has excellent compression, while PNG is lossless. The trade-off is universal compatibility and perfect quality preservation for editing.</p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-foreground">Does my browser support AVIF?</h3>
              <p>Chrome, Firefox, and Safari all support AVIF. If the conversion works, your browser supports it. If not, try updating your browser to the latest version.</p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-foreground">What is AVIF and why is it not supported everywhere?</h3>
              <p>AVIF is a relatively new format (standardized in 2019) based on the AV1 video codec. While browser support is strong, many desktop applications and older software haven&apos;t added AVIF support yet, making conversion to PNG or JPG necessary.</p>
            </div>
          </TabsContent>
        </Tabs>
      </section>
